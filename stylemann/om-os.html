...
<body>
    ...
    <script>
        let destOm = document.querySelector(".page-container");
        ...
        async function getJson() {
            ...
            let myJsonOm = await fetch("http://rockbottomproductions.dk/kea/sem2/stylemann/wp-json/wp/v2/om_os");

            jsonFileOm = await myJsonOm.json();
        ...
        function visIndhold() {
            ...
            jsonFileOm.forEach(indholdData => {
